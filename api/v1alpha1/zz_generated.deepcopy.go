...
func (in *RealTimeAppSpec) DeepCopyInto(out *RealTimeAppSpec) {
	*out = *in
	if in.RealTimeThreads != nil {
		in, out := &in.RealTimeThreads, &out.RealTimeThreads
		*out = make([]RealTimeThreadSpec, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RealTimeThreadSpec) DeepCopyInto(out *RealTimeThreadSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RealTimeThreadSpec.
func (in *RealTimeThreadSpec) DeepCopy() *RealTimeThreadSpec {
	if in == nil {
		return nil
	}
	out := new(RealTimeThreadSpec)
	in.DeepCopyInto(out)
	return out
}
